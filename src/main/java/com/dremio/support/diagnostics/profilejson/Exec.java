...
public class Exec {
  ...
  public void run(final boolean showPlanningDetail) throws IOException {
    ...
    final ConsoleReporter report = new ConsoleReporter();
    report.output(
        new ProfileJsonComparisonTextReport(
            differences, this.profile1Provider.getFilePath(), this.profile2Provider.getFilePath()));
  }
}
