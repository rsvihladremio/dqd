...
public class QueriesJsonHtmlReportTest {
  ...
  // //     List<Query> queries = Arrays.asList(dropQueryThatLastsOneSecond,
  // queryThatIsThreeSecondsLater);
  // //     var report = new QueriesJsonHtmlReport(5, queries.stream(), 100000L, 3600L, noOpStart,
  // noOpEnd);
  ...
  // //     htmlText =
  // //         new QueriesJsonHtmlReport(5, queries.stream(), 100000L, 3600, noOpStart,
  // noOpEnd).getText();
  ...
  // queryThatIsThreeSecondsLater);
  // //     var report =
  // //         new QueriesJsonHtmlReport(5, queries.stream(), 100000L, 3600L, startFilter,
  // endFilter);
  // //     htmlText = report.getText();
  // //     assertThat(htmlText)
  // //         .contains(
